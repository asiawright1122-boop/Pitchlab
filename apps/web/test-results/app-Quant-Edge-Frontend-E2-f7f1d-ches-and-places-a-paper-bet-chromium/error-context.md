...
- Name: app.spec.ts >> Quant Edge Frontend E2E Tests >> TMA Play page - loads mock wallet, renders matches, and places a paper bet
- Location: e2e/app.spec.ts:19:7
...
Expected pattern: /RU/
Received string:  "PitchLab | 2026赛程全部赛程A组B组C组D组E组F组G组H组I组J组K组L组赔率冠军赔率及预测最佳射手赔率比赛赔率世界杯模拟器二级赔率与盘口积分榜球队积分榜射手榜助攻榜红黄牌统计关于世界杯赛制介绍举办城市新闻最新资讯注册 / 登录"
Timeout: 5000ms

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('header')
    14 × locator resolved to <header class="bg-[#1a1a2e] sticky top-0 z-50">…</header>
       - unexpected value "PitchLab | 2026赛程全部赛程A组B组C组D组E组F组G组H组I组J组K组L组赔率冠军赔率及预测最佳射手赔率比赛赔率世界杯模拟器二级赔率与盘口积分榜球队积分榜射手榜助攻榜红黄牌统计关于世界杯赛制介绍举办城市新闻最新资讯注册 / 登录"
